...
import { Github, Key, Mail, Eye, EyeOff, Loader2 } from 'lucide-react';
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
                ...
                <Input id="password" type={showPassword ? 'text' : 'password'} required defaultValue="password" className="pl-10 pr-10" />
                <Button
                  type="button"
                  variant="ghost"
                  size="icon"
